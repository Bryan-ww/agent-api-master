...
def _compatible_loop_factory(use_subprocess: bool = False):
    if sys.platform == "win32":
...
from src.api.crons import router as crons_router
from src.api.rag import router as rag_router
from src.api.runs import router as runs_router
from src.api.stateless_runs import router as stateless_runs_router
from src.api.store import router as store_router
from src.api.threads import router as threads_router
from src.config import CorsConfig, HttpConfig, get_config_dir, load_http_config
from src.core.app_loader import load_custom_app
from src.core.auth_deps import auth_dependency
from src.core.database import db_manager
from src.core.health import router as health_router
from src.core.migrations import run_migrations_async
from src.core.redis_manager import redis_manager
from src.core.route_merger import (
    merge_exception_handlers,
    merge_lifespans,
)
from src.middleware import ContentTypeFixMiddleware, StructLogMiddleware
from src.models.errors import AgentProtocolError, get_error_type
from src.observability.metrics import setup_prometheus_metrics
from src.observability.setup import setup_observability
from src.services.broker import broker_manager
...
from src.services.lease_reaper import lease_reaper
...
def _log_connection_help(error: Exception) -> None:
    ...
    logger.error(
        ...
        "  - Missing .env file?  Copy .env to .env and configure it"
    )
